...
export MODEL_DIR=$MODELS_DIR/vinvl/vg
...
python3 oscar/run_vqa_student.py -j 8 \
    ...
    --learning_rate 5e-05 \
    --lang ja \
    --model_name_or_path /scratch/kshitij98/models/vinvl/vg/best-7 \
    # --only_classifier \
    # --model_name_or_path /scratch/kshitij98/models/vinvl/vg/checkpoint-9-27700 \
    # --only_classifier \
    # --layers $LAYERS \
    # --do_kd \
