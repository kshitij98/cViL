...
bash extract-features-general.sh
...
export MODEL_DIR=$MODELS_DIR/vinvl-base/pretrained/$EXPERIMENT_ID

export NUM_LABELS=3129
export SSD=1
export FINAL_LAYER_ONLY=0
...
python3 oscar/run_vqa_student.py -j 8 \
    ...
    --num_train_epochs 10 \
    --output_dir $MODEL_DIR/kd-general \
